...
class Ennemis(pygame.sprite.Sprite):
    ...
    def __init__(self, x):
        ...
        self.sprite_count = 0
        self.direction = Ennemis.NONE 
        self.image = Ennemis.IMAGES[self.direction][self.sprite_count//Gameconfig.NB_FRAMES_PER_SPRITE_PLAYER]
        self.mask = Ennemis.MASKS[self.direction][self.sprite_count//Gameconfig.NB_FRAMES_PER_SPRITE_PLAYER]
        self.vx = 0
        self.vy = 0
        self.count_cle = 0
        self.on_ground = True
