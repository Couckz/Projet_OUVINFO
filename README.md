...
Les actions que le joueur pourra effectuer sont relativement simples : bouger de gauche à droite, sauter sur des plateformes). 
...
- [ OK ] Implementer les colisions avec les plateformes présentes sur la surcouche du niveau 1
...
- [ OK ] Implémenter les différents évenements (joueur qui récolte une clé, passage vers le prochain niveau)
